"""
Django settings for extension_tracker project.
...
SECRET_KEY = 'django-insecure-j(fi3z_r6!y2dyg^(=9lq^oeg-jrboul@hid3*tau*009i^*$i'
...
ROOT_URLCONF = 'extension_tracker.urls'
...
WSGI_APPLICATION = 'extension_tracker.wsgi.application'
...
STATICFILES_DIRS = [
     os.path.join(BASE_DIR, 'media_features', 'static'),
]
